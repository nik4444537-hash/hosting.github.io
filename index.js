...
songsArray.map(function (song) {
    ...
    arr.push(`
<div  class="song${song.id}" class="song">
...
for (var i = 0; i < songIdStore.length; i++) {
    var songIdentifier = document.getElementsByClassName("song" + (i + 1))[0];
    songIdentifier.style.cursor = "pointer";
    songIdentifier.addEventListener("click", function (e) {
        ...
        for (var i = 1; i < songIdStore.length + 1; i++) {
